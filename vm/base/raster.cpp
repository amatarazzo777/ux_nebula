 ...
 *      Author: anthonym
 *
 * @description The kitchens of the long way verses the short way
...
void raster::setPixel(int x0, int y0) {

}

void raster::plotLine(int x0, int y0, int x1, int y1)
{
...
#if 0
// maybe after using ray tracing, these types of mathematical formulas can be adopted to
// coloring ui objects in real time, a quick and refined intersection routine with
// a light attenuation factor, glow and object material. There is susprisingly more that I do not know yet
// but a splendend software glow, roundiness can be used in UI painting. Perhaps some effects
// anlong with light map parameters for input, bump map data input, and even local parameterized yet
// operating automatically as a cohesive element linked within the render workflow. Types of automated
// interfaces with a yeild of futurism.
void raster::plotLine3d (int x0, int y0, int z0, int x1, int y1, int z1)
{
    int dx = abs(x1-x0), sx = x0 < x1 ? 1 : -1;
    int dy = abs(y1-y0), sy = y0 < y1 ? 1 : -1;
...
void raster::plotEllipse(int xm, int ym, int a, int b)
{
...
void raster::plotOptimizedEllipse(int xm, int ym, int a, int b)
{
...
void raster::plotCircle(int xm, int ym, int r)
{
...
void raster::plotEllipseRect(int x0, int y0, int x1, int y1)
...
void raster::plotQuadBezierSeg(int x0, int y0, int x1, int y1, int x2, int y2)
...
void raster::plotQuadBezier(int x0, int y0, int x1, int y1, int x2, int y2)
...
void raster::plotQuadRationalBezierSeg(int x0, int y0, int x1, int y1,
...
void raster::plotQuadRationalBezier(int x0, int y0, int x1, int y1,
                            int x2, int y2, float w)
...
void raster::plotRotatedEllipse(int x, int y, int a, int b, float angle)
...
void raster::plotRotatedEllipseRect(int x0, int y0, int x1, int y1, long zd)
...
void raster::plotCubicBezierSeg(int x0, int y0, float x1, float y1,
...
void raster::plotCubicBezier(int x0, int y0, int x1, int y1,
...
void raster::plotLineAA(int x0, int y0, int x1, int y1)
...
void raster::plotCircleAA(int xm, int ym, int r)
...
void raster::plotEllipseRectAA(int x0, int y0, int x1, int y1)
...
void raster::plotQuadBezierSegAA(int x0, int y0, int x1, int y1, int x2, int y2)
...
void raster::plotQuadRationalBezierSegAA(int x0, int y0, int x1, int y1,
                                 int x2, int y2, float w)
...
void raster::plotCubicBezierSegAA(int x0, int y0, float x1, float y1,
                          float x2, float y2, int x3, int y3)
...
void raster::plotLineWidth(int x0, int y0, int x1, int y1, float wd)
...
void raster::plotQuadSpline(int n, int x[], int y[])
...
void raster::plotCubicSpline(int n, int x[], int y[])
